...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-16"> {/* Added padding and ID for navigation */}
      <h2 className="text-3xl font-bold text-center mb-12">My Projects</h2> {/* Styled heading */}
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"> {/* Added responsive grid with gap and centered container */}
